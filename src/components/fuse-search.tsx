...
export function FuseSearchModal() {
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 text-sm text-gray-500 hover:text-gray-700 border border-gray-200 hover:bg-gray-50 rounded-md transition-colors flex-1 min-w-0"
      >
        <svg
          width="16"
          height="16"
        ...
        <span className="text-gray-500 flex-shrink-0">Search</span>
        <div className="ml-auto flex items-center gap-1 flex-shrink-0">
          <kbd className="hidden sm:inline-block px-1.5 py-0.5 text-xs font-mono bg-white/80 border border-gray-200/60 rounded text-gray-400">
            ⌘
          </kbd>
          <kbd className="hidden sm:inline-block px-1.5 py-0.5 text-xs font-mono bg-white/80 border border-gray-200/60 rounded text-gray-400">
            K
  ...
  return (
    <div className="fixed inset-0 bg-gray-900/20 backdrop-blur-sm flex items-start justify-center pt-20 z-50">
      <div className="bg-white rounded-lg shadow-2xl border border-gray-200 w-full max-w-2xl mx-4 max-h-[calc(100vh-6rem)] flex flex-col overflow-hidden">
